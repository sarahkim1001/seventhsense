...
const auditData = {
  ...
  sections: {
    ...
    resolution: "In response to this, a new movement is emerging: Friction-Maxxing. This isn't about being \"anti-tech\"; it's about intentionally choosing resistance to keep our minds sharp. Friction-maxxing is \"cyborgania\" in practice—it is the refusal to let life be entirely \"seamless\". It is about reclaiming our role as the primary driver of our tools. It means choosing to work with AI as a partner, rather than letting it replace our own thinking. This preserves our Somatic Sovereignty: the simple, grounded right to feel the weight of our own lives and the value of our own efforts.",
  },
  sources: [
